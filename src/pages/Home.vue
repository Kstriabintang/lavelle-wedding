...
useHead({
  ...
  meta: [
    ...
    { property: 'og:image', content: 'https://lavelle.my.id/img/og-home.jpg' },
    { property: 'og:image:width', content: '1200' },
    { property: 'og:image:height', content: '630' },
    { property: 'og:image:alt', content: 'Lavelle — Undangan Pernikahan Digital Premium' },
    ...
    { name: 'twitter:image', content: 'https://lavelle.my.id/img/og-home.jpg' },
  ],
