...
![GitHub Pages](https://img.shields.io/badge/Hosted%20on-GitHub%20Pages-222?style=flat&logo=github)
...
| --- | --- | --- |
| [**Classic**](https://lavelle.my.id/demo/klasik/) | Blush & Sage | Warm, soft, timeless |
...
- **Digital Envelope & Wedding Gift** — gifts via bank transfer / QRIS, or a postal address.
...
- **HTML · CSS · JavaScript** — fast, fully static, no backend required.
- **Three.js / WebGL** — for the 3D cinematic demo.
- **Canvas & CSS Animations** — living backgrounds, particles, and parallax.

Optimized for performance and mobile, with no build step — deploys straight to
GitHub Pages.
...
```
lavelle/
├── index.html          # Landing page (services, pricing, FAQ)
├── css/style.css       # Global styles
├── js/main.js          # Interactions
├── img/                # Brand assets & photo references
├── blog/               # SEO articles (tips, themes, local guides)
├── demo/               # Live invitation demos
│   ├── klasik/         #   Classic — Blush & Sage
│   ├── modern/         #   Modern — Midnight & Gold
│   ├── sinema/         #   Sinema — cinematic, living 3D banners
│   └── modern-3d/      #   Modern 3D — Three.js / WebGL
├── sitemap.xml
├── robots.txt
└── CNAME               # lavelle.my.id
```
...
© 2025 Lavelle. All rights reserved. This repository is for portfolio purposes only. Do not copy, reuse, or redistribute without permission.
